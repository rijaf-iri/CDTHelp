...
The menu `r menuselection('Quality Control', 'Check Stations Coordinates')` allows to check if there are duplicated and implausible coordinates, or stations outsides a provided shapefile. It will display a tabbed widget on the left panel, allows to enter the inputs data.

The tab `r onglet('Input')` allows to enter the inputs data and run the command to check and correct the stations coordinates.
