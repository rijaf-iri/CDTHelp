...
`r put.image("images/cdt_file/open_ncdf.png", height = 40, width = 50)`
...
`r put.image("images/cdt_file/save_table.png", height = 50, width = 50)`
...
`r put.image("images/cdt_file/save_image1.png", height = 40, width = 50)`
...
1.  Enter the name of the file to save the image (the image will be saved in your working directory) or the full path to the file. You can save the image in JPEG or PNG format. When typing a filename, do not forget to add the extension on the filename (**Example**: *my_image.jpg* or *my_image.png*).
	...
	`r put.image("images/cdt_file/save_image2.png", height = 60, width = 60)`
...
The menu `r menuselection('File','Configuration')` allows to select the language, set the missing values code, change the working directory, and configure the Tck/Tk libraries.

The tab `r onglet('CDT Configuration')` allows to set general CDT configuration options

`r put.image("images/cdt_file/cdt_config.png", height = 45, width = 55)`
...
`r put.image("images/cdt_file/tcl_config_mac.png", height = 40, width = 50)`
...
`r put.image("images/cdt_file/tcl_config_win.png", height = 55, width = 45)`
...
`r put.image("images/cdt_file/status_bar1.png", height = 300)`
...
`r put.image("images/cdt_file/status_bar2.png", height = 300)`
