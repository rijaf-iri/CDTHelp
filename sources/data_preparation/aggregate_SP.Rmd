...
The menu `r menuselection('Aggregate Data', 'Aggregate/Disaggregate Spatial NetCDF data')` allows to perform a spatial aggregation and disaggregation, in other words, regridding. Regridding is the process of interpolating from one grid resolution to a different grid resolution.
