...
6. Enter the name of the file to save the formatted stations data or the full path to the file. You can also click on ![][browsebutf], it opens a file dialog where you can select the name, path and type of file (txt or csv).
