...
6. Type the name of the file to save the formatted stations data or the full path to the file. You can also click on ![][browsebutf] on the left, it opens a file dialog where you can select and/or type the name, path and type of file (txt or csv).
